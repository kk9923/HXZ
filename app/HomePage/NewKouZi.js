...
export default class HomePage extends Component {
     ...
     */
    getLoanLists(booble){
        const map2 = new Map().set('apiVersion', '1.3.0').set('appCode','HXK1.3.0').set('appName','43').set('channel','ios').set('flag','cash').set('loanType','').set('orderBy','1').set('page',this.state.pageNum).set('pageSize','10')
